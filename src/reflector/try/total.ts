...
async function main() {
  ...
  await client.subscribe('harvester/kusama/validators/#', { qos: 2 });
  // await client.subscribe('harvester/kusama/validators/#');

  setInterval(() => {
    console.log(validators['GXaUd6gyCaEoBVzXnkLVGneCF3idnLNtNZs5RHTugb9dCpY']);
